...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($email && $password) {
    ...
    // Note: En production, utiliser password_verify() avec un hash stocké
    // Pour la démo, on accepte tout utilisateur trouvé par email
    // Remplacer par: if ($client && password_verify($password, $client['password']))
    if ($client) {
