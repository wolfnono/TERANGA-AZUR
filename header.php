...
<nav class="navbar" id="navbar">
  ...
  <ul class="nav-links" id="navLinks">
    ...
    <li><a href="admin/dashboard.php" class="<?= $current_page === 'dashboard' ? 'active' : '' ?>" style="color:var(--or-sable);font-weight:600;"><i class="fas fa-shield-alt"></i> Admin</a></li>
    <?php endif; ?>
    <li><a href="mes-reservations.php" class="<?= $current_page === 'mes-reservations' ? 'active' : '' ?>">Mes Réservations</a></li>
    <li><a href="mon-compte.php" class="<?= $current_page === 'mon-compte' ? 'active' : '' ?>">
      <i class="fas fa-user-circle"></i> Mon Compte
    </a></li>
    <li><a href="logout.php" style="color:rgba(255,180,180,0.85);" onclick="return confirm('Se déconnecter ?')">
